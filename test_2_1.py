...
#
def Random_Gen():
#______________ Задаём рандомно тональность первого аккорда (мажор/минор), первую ноту первого аккорда, количество нот в аккорде, вспомогательные списки возможных первых нот последующих аккордов и количество аккордов
	ch0ton = randint(0,1)
	ch0 = randint(0, 11)
...
#______________ Формируем список аккордов
	chord = []
...
#
#__________________________________________________________________________ Класс, вдохновлённый гитарным боем(жалкая имитация)
#
class Strum_func:
#
    def mute(self):
...
#sequence.mute()
#
#__________________________________________________________________________________________Ударные
#
class Drum_func:
#
    def mute(self):
